...
console.log("val from storage enter : ",val);
      ...
      //ayaaaaaaaaaa
      this.slogn = val.slogn;
      this.slognImage = val.slogn_image;
      this.city = val.extraInfo.city_id;
      console.log("registered city: "+this.city);
      //////////////
         ...
         this.type = type_val
          if (type_val == 0) {
            ...
            for (let i = 0; i < servicesObj.length; i++) {
              ...
              if(this.helper.userType != 2 && this.helper.userType != 5){
  ...
  openEditProfile() {
    this.storage.get('type').then(val => {
      if (val == 1) {
        ...
        this.navCtrl.push('EditProfilePage', {registeredCity:this.city})
      }else if (val == 5) {
