...
export class EditProfilePage {
  ...
  constructor(public toastCtrl: ToastController, private camera: Camera, public helper: HelperProvider,
    ...
    //ayaaaaaa
    this.city = navParams.get("registeredCity");
    console.log("registeredCity: "+this.city);
    ////
