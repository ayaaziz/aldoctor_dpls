...
var offset = new Date().getTimezoneOffset();
  ...
  save(){
    ...
    // this.days.forEach(item => {
    //   item[1][0] = new Date(item[1][0]).getHours() +":"+ new Date(item[1][0]).getMinutes();
    //   item[2][0] = new Date(item[2][0]).getHours() +":"+ new Date(item[2][0]).getMinutes();
    //   item[1][1] = new Date(item[1][1]).getHours() +":"+ new Date(item[1][1]).getMinutes();
    //   item[2][1] = new Date(item[2][1]).getHours() +":"+ new Date(item[2][1]).getMinutes(); 
    // });
