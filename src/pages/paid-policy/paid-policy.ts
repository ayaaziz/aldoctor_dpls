...
/**
 * Generated class for the PaidPolicyPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-paid-policy',
  templateUrl: 'paid-policy.html',
})
export class PaidPolicyPage {
  lang_direction= ""
  privacy_data
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PaidPolicyPage');
    this.storage.get("access_token").then(data=>{
      ...
      if (navigator.onLine) {
        this.storage.get('type').then(val=>{
          ...
          this.service.payment_privacyForAllServices(data, val,this.helper.currentLang,
            resp=>{
      ...
      // this.service.payment_privacy(data, this.helper.currentLang,
      //   resp=>{
      //     console.log("resp from about-app : ",resp);
      //     this.privacy_data = resp[0].value;
      //     console.log("val from about app",this.privacy_data);
